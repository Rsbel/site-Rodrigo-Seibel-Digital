...
export function WhatsAppFloat({ lang }: WhatsAppFloatProps) {
  ...
  return (
    <a
      ...
      aria-label={label}
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-[#25d366] hover:bg-[#1ebe5d] text-white font-bold text-sm px-4 py-3 rounded-full shadow-2xl whatsapp-float group transition-colors duration-200"
    >
