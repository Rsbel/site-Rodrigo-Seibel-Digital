    ...
    services: [
      {
        ...
        desc: "Atraímos os clientes certos com campanhas altamente otimizadas para o seu mercado.",
        highlight: "Mais clientes qualificados",
        featured: false,
      },
      {
        title: "WhatsApp com IA",
        platforms: "Automação inteligente",
        desc: "IA que responde, qualifica e vende para seus clientes em tempo real, sem intervenção humana.",
        highlight: "Vende enquanto você dorme",
        featured: false,
      },
      {
        title: "Instagram Automático",
        platforms: "Comentou → Recebeu",
        desc: "Cliente comenta no seu post e recebe automaticamente uma mensagem personalizada no direct.",
        highlight: "Cada comentário vira lead",
        featured: true,
      },
      {
        title: "CRM Inteligente",
        platforms: "Controle total",
        desc: "Gerencie todos os leads, histórico de conversas e pipeline de vendas em um só lugar.",
        highlight: "Nunca perca um lead",
        featured: false,
      },
      {
        title: "Sites de Alta Conversão",
        platforms: "Botão WhatsApp direto",
        desc: "Sites criados para converter visitantes em clientes com botão de WhatsApp estratégico.",
        highlight: "Conversão máxima",
        featured: false,
      },
      {
        title: "Aplicativos",
        platforms: "iOS · Android",
        desc: "Seu negócio na palma da mão dos seus clientes. Escalabilidade total.",
        highlight: "Negócio escalável",
        featured: false,
      },
    ],
    ...
    services: [
      {
        title: "Tráfico Pago",
        platforms: "Google · Meta · TikTok",
        desc: "Atraemos los clientes correctos con campañas altamente optimizadas para tu mercado.",
        highlight: "Más clientes calificados",
        featured: false,
      },
      {
        title: "WhatsApp con IA",
        platforms: "Automatización inteligente",
        desc: "IA que responde, califica y vende a tus clientes en tiempo real, sin intervención humana.",
        highlight: "Vende mientras dormís",
        featured: false,
      },
      {
        title: "Instagram Automático",
        platforms: "Comentó → Recibió",
        desc: "Cliente comenta en tu post y recibe automáticamente un mensaje personalizado en el direct.",
        highlight: "Cada comentario es un lead",
        featured: true,
      },
      {
        title: "CRM Inteligente",
        platforms: "Control total",
        desc: "Manejá todos los leads, historial de conversaciones y pipeline de ventas en un solo lugar.",
        highlight: "Nunca perdas un lead",
        featured: false,
      },
      {
        title: "Sitios de Alta Conversión",
        platforms: "Botón WhatsApp directo",
        desc: "Sitios creados para convertir visitantes en clientes con botón de WhatsApp estratégico.",
        highlight: "Conversión máxima",
        featured: false,
      },
      {
        title: "Aplicaciones",
        platforms: "iOS · Android",
        desc: "Tu negocio en la palma de la mano de tus clientes. Escalabilidad total.",
        highlight: "Negocio escalable",
        featured: false,
      },
    ],
