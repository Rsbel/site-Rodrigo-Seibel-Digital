      ...
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="hidden sm:inline-flex items-center gap-2 bg-[#e85d04] hover:bg-[#ff7b2e] text-white font-semibold text-sm px-4 py-2 rounded-full transition-all duration-200 glow-orange-sm"
          >
            ...
            {lang === "pt" ? "Falar agora" : "Hablar ahora"}
          </a>
        </div>
      </div>
    </header>
